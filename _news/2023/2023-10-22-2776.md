...
[![image](/images/prog-iso-ldav23.png-srcw.jpg){:style="max-width: 100%"}](/images/prog-iso-ldav23.png-srcw.jpg)
- Caption: Interactive full-resolution isosurface visualization of the 2048×2048×1920 Richtmyer-Meshkov (R-M) data set in the browser.
...
**Citation**: Usher, W., Dyken, L., Kumar, S., Speculative Progressive Raycasting for Memory Constrained Isosurface Visualization of Massive Volumes, *13th IEEE Symposium on Large Data Analysis and Visualization (LDAV 2023)*, Melbourne, Australia, 2023-10-22.